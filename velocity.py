    ...
    if aios.broadcast_func():
        ...
        if (not aios.encoderIsReady(Server_IP_1, 1)):
            ...
            if aios.enable(Server_IP_1, 1):
                ...
                aios.velRampEnable(False, Server_IP_1, 1)
                # aios.trapezoidalMove(0, Server_IP_1, 1)
                # time.sleep( 10 )

                aios.setVelocity(5000, 0, Server_IP_1, 1)
                time.sleep(2)
                aios.setVelocity(10000, 0, Server_IP_1, 1)
                time.sleep(2)
                aios.setVelocity(12000, 0, Server_IP_1, 1)
                time.sleep(2)
                aios.setVelocity(13000, 0, Server_IP_1, 1)
                time.sleep(2)
                aios.setVelocity(10000, 0, Server_IP_1, 1)
                time.sleep(2)
                aios.setVelocity(5000, 0, Server_IP_1, 1)
                time.sleep(2)
                aios.setVelocity(0, 0, Server_IP_1, 1)
                time.sleep(2)
                ...
                #     print(pos)
                #     aios.setVelocity(pos, Server_IP_1, 1)
